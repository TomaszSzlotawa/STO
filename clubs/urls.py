...
urlpatterns = [
    ...
    path("pdf/<int:mezocycle_id>", views.pdf_view, name='pdf_view'),
    ...
    path("panel/<int:club_id>", views.club_panel, name='club_panel'),
    ...
    path("teams/coaching_staff/delete/<int:team_id>;<int:coach_id>", views.delete_coach_from_team, name='delete_coach_from_team'),
    ...
    path("teams/mezocycles/implemented/delete/<int:mezocycle_id>", views.delete_implemented_mezocycle, name='delete_implemented_mezocycle'),
    path("teams/mezocycles/implemented/<int:mezocycle_id>", views.review_implemented_mezocycle, name='review_implemented_mezocycle'),
    ...
    path("teams/trainings/attendance/report/<int:training_id>", views.training_attendance_report, name='training_attendance_report'),
    path("teams/attendance/<int:team_id>", views.team_attendance_report, name='team_attendance_report'),
